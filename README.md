...
## Quick Start
0. Install this package by Package Manager (Unity menu: Window/Package Manager), input the git url:
    > git@github.com:yuyang9119/UnityExtensionsLocalization.git
